...
[![Build Status](https://img.shields.io/travis/stckwok/docker-bitcoin.svg)](https://travis-ci.org/stckwok/docker-bitcoin)
[![License](https://img.shields.io/github/license/stckwok/docker-bitcoin.svg)](https://github.com/stckwok/docker-bitcoin/blob/master/LICENSE)
...
* [Bitcoin Core](https://hub.docker.com/r/stckwok/bitcoin/tags/)
* [Bitcoin Classic](https://hub.docker.com/r/stckwok/bitcoinclassic/tags/)
* [Bitcoin Unlimited](https://hub.docker.com/r/stckwok/bitcoinunlimited/tags/)
* [Bitcoin XT](https://hub.docker.com/r/stckwok/bitcoinxt/tags/)
* [btc1 Core](https://hub.docker.com/r/stckwok/btc1/tags/)
...
```
$ docker run stckwok/bitcoin:0.11
```

Or, to run the `0.11.1` release specifically:

```
$ docker run stckwok/bitcoin:0.11.1
```
...
```
$ docker run -d --rm --name bitcoind stckwok/bitcoin
```
...
```
$ docker run --name bitcoind-testnet stckwok/bitcoin bitcoind -testnet
```
...
```
$ docker run -d --rm --name bitcoind -v bitcoin-data:/data stckwok/bitcoin
$ docker ps
...
```
$ docker run -d --rm --name bitcoind -v "$PWD/data:/data" stckwok/bitcoin
$ ls -alh ./data
```
...
```
$ docker run -d --rm --name bitcoind -v bitcoin-data:/data stckwok/bitcoin
$ docker run --rm --network container:bitcoind stckwok/bitcoin bitcoin-cli getinfo
```
...
$ docker run -d --rm --name bitcoind -v bitcoin-data:/data --network bitcoin stckwok/bitcoin
$ docker run --rm --network bitcoin stckwok/bitcoin bitcoin-cli -rpcconnect=bitcoind getinfo
```
